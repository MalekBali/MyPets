...
try{
    $req="SELECT * FROM customers where id='$id_etd'";
    $res=$conn->query($req);
        ...
        <div class="col-md-5 offset-md-1">
          <div class="form_container">
            ...
            <form action="modifier2.php" method="post">
              ...
              <div>
                <input type="email" name="email"placeholder="Email" value="<?php echo($login)?>"/>
              </div>
              <div>
              ...
              <div>
                <input type="text" name="address" class="message-box" placeholder="Shipement Address"value="<?php echo($address)?>" />
              </div>
              <div class="d-flex ">
